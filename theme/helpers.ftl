...
<div class="font-italic">
  ...
  <ul>
    ...
    [/#if]
    <li>Make sure that both passwords you enter match.</li>
  </ul>
</div>
[/#macro]
...
[#macro permHeadTag title]
<head>
  <title>${title} | Permanent.org</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
  <link rel="apple-touch-icon" sizes="180x180" href="${PERM_DOMAIN}/app/assets/icon/apple-touch-icon.png" />
  <link rel="icon" type="image/png" sizes="32x32" href="${PERM_DOMAIN}/app/assets/icon/favicon-32x32.png" />
  <link rel="icon" type="image/png" sizes="16x16" href="${PERM_DOMAIN}/app/assets/icon/favicon-16x16.png" />
  <link rel="manifest" href="${PERM_DOMAIN}/app/assets/icon/site.webmanifest" />
  <link rel="mask-icon" href="${PERM_DOMAIN}/app/assets/icon/safari-pinned-tab.svg" color="#800080" />
  <link rel="shortcut icon" href="${PERM_DOMAIN}/app/assets/icon/favicon.ico" />
  <meta name="msapplication-TileColor" content="#2b5797" />
  <meta name="msapplication-config" content="${PERM_DOMAIN}/app/assets/icon/browserconfig.xml" />
  <meta name="theme-color" content="#ffffff" />
